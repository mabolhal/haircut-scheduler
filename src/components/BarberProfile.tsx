...
export default function BarberProfile({ barberId }: { barberId: number }) {
  ...
  useEffect(() => {
    async function fetchBarber() {
      ...
      try {
        const url = `/api/barber?id=${barberId}`;
        ...
        if (response.ok) {
          ...
          console.error('Failed to fetch barber:', response.statusText);
        }
      } catch (error) {
